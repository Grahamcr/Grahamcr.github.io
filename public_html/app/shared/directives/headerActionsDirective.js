        ...
        .directive("closeMenu", ['$location', function($location){
            return function(scope, element, attrs){
                element.bind("click", function(){
                    ...
                    tl.to(".responsive-icon", 0, {ease:Power3.easeOut, display:"inherit"});
                    tl.to(".close", 0, {ease:Power3.easeOut, display:"none"});
                    tl.to(".responsive-menu", 0, {ease:Power3.easeOut, display:"none"});
        ...
        .directive("openMenu", ['$location', function($location){
            return function(scope, element, attrs){
                element.bind("click", function(){
                    ...
                    var tl = new TimelineLite();
                    tl.to(".responsive-icon", .1, {ease:Power3.easeIn, display:"none"});
                    tl.to(".close", .1, {ease:Power3.easeIn, display:"inherit"});
                    tl.to(".responsive-menu", 1, {ease:Power3.easeIn, display:"inherit"});
